...
/**
 * Servlet implementation class surveyShowController
 */
@WebServlet("/survey/show.do")
public class surveyShowController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public surveyShowController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try 
		{
			...
			surveyModel sm=iss.showSurvey(id);
